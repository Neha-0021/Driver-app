...
class LoginComponent extends State<Login> {
 ...
 validateAndLogin(context, homeState) async {
  if (homeState.driverUsername != "" && homeState.driverPassword != "") {
    homeState.driverLogin().then((value) => {
      alert.SnackBarNotify(context, value['message']),
      if (value["code"] == 200) {Navigator.pushNamed(context, "bottomBar")}
    });
  } else {
          ...
          children: [
            ...
            Padding(
                ...
                child: CustomTextInput(
                  ...
                  onChangeText: (String e) =>
                      {homeState.updateDriverUsername("driverusername")},
            ...
            Padding(
                ...
                child: PasswordInput(
                  ...
                  onChangeText: (String e) =>
                      {homeState.updateDriverPassword("driverpassword")},
                  keyboardType: TextInputType.text,
                  showHidePassword: () {
                    setState(() {
